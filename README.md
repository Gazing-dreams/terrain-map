...
> 本仓库为衍生项目：在原版 Voronoi 地形生成算法基础上，扩展了 **道路系统（领地辐射 + 首都 MST）**、**领地划分**、**中英文双语词库命名系统**（原版 / 奇幻风格 / 仙侠风）与完整的地图工具 UI（缩放、全屏、图层显隐、名称管理、数据导入导出）。
...
- **地图工具**：缩放平移、网页内全屏、图层显隐（道路/城市/领地）、世界规模档位（1x-4x，面积等比放大、组件不变、同屏容纳更多领地）、手动新增/删除城市、导出 PNG、导入导出地图数据
